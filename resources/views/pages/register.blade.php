...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/Profile-with-data-and-skills.css')}}">
...
<main>
    <div class="container "
        ...
        <div class="row d-flex d-xl-flex justify-content-center justify-content-xl-center">
            <div class="col-sm-12 col-lg-6 col-xl-9 col-xxl-7 bg-white shadow-lg" style="border-radius: 5px;">
                <div class="p-4">
                    <div class="text-center">
                        <h4 class="text-dark mb-4">إنشاء حساب جديد</h4>
                    </div>
                    <form class="user w-75 m-auto">
                        ...
                        <button class="btn btn-primary d-block btn-user w-auto m-auto " style="background-color: coral"  id="submitBtn" type="submit">Register Account</button>
                        <hr>
                    </form>
                    <div class="text-center"><a class="small" href="forgot-password.html">نسيت كلمة المرور؟</a></div>
                    <div class="text-center"><a class="small" href="login.html">لديك حساب ؟</a></div>
                </div>
            </div>
        </div><script>
